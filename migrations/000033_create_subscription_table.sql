...
CREATE TABLE subscriptions (
    ...
    sessions_used_this_month INT NOT NULL DEFAULT 0 CHECK (sessions_used_this_month >= 0 AND sessions_used_this_month <= sessions_per_month),    amount                  BIGINT NOT NULL,
