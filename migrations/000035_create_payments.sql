...
CREATE TABLE IF NOT EXISTS payments (
    ...
    payment_type           VARCHAR NOT NULL CHECK (payment_type IN ('subscription', 'tip')),
    provider               VARCHAR NOT NULL CHECK (provider IN ('stripe', 'paystack')),
    ...
    payment_status         VARCHAR NOT NULL CHECK (payment_status IN ('pending', 'successful', 'failed', 'wallet_reconciliation_needed')),
    paid_at                TIMESTAMPTZ,
