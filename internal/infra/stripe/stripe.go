...
func (c *Client) Charge(ctx context.Context, params ChargeParams) (*ChargeResult, error) {
	if params.IdempotencyKey == "" {
		return nil, errors.New("idempotency key is required for charge operations")
	}
...
func (c *Client) Refund(ctx context.Context, paymentIntentID string, idempotencyKey string) error {
